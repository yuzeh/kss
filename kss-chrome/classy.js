...
;(function(undefined) {
  ...
  Class.$extend = function(properties) {
    ...
    if (properties.__instancevars__) {
      var fromJSONStr = "var fJSON = function(json) { ";
      var toJSONStr = "var tJSON = function() { var json = {}; ";
      for (var i = 0, n = properties.__instancevars__.length; i != n; ++i) {
        var key = properties.__instancevars__[i];
        fromJSONStr += "this." + key + "(json." + key +"); ";
        toJSONStr += "json." + key + " = this." + key + "(); ";
        var fn = "var curFunc = function(val) { if(val) this._" + key + " = val; return this._" + key +"; }";
        eval(fn);
        properties[key] = curFunc;
      }
      if(!properties.fromJSON && !properties.toJSON)
      {
      	fromJSONStr += "};";
      	toJSONStr += " return json; };";
      	eval(fromJSONStr);
      	eval(toJSONStr);
      	properties.fromJSON = fJSON;
      	properties.toJSON = tJSON;
      }
    }
